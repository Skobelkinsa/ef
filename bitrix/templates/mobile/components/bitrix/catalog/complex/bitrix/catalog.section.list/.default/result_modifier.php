...
if($APPLICATION->GetCurPage(false) != "/produktsiya/"):
    unset($arResult['SECTIONS']);
    $arResult['SECTIONS_COUNT'] = 0;
    $arSelect = array("ID", "CODE", "NAME", "SECTION_PAGE_URL");
    $arFilter = array('IBLOCK_ID' => $arParams["IBLOCK_ID"], 'ACTIVE' => 'Y', 'DEPTH_LEVEL ' => 1, 'SECTION_ID' => 0);
    ...
    while ($arSection = $rsSections->Fetch())
    {
        ...
        $arSection['SECTION_PAGE_URL'] = $arSection['SECTION_PAGE_URL'].$arSection['CODE']."/";
