...
?>
    ...
    <div class="title">
        ...
        <a href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>" class="back"></a>
    </div>
    ...
    <div class="blog">
        <div class="blog_filter">
            <div class="scroll-block">
                <div class="blog_filter-item blog_filter-category">
                    <div class="blog_filter-title">
                        <?=GetMessage('CATEGORY_TITLE')?>
                    </div>
                ...
                <div class="blog_filter-item blog_filter-tags">
                ...
                <div class="blog_filter-sort">
                    ...
                    <a href="<?=$arResult['FOLDER']?>?sort=popular"<?if($_GET['sort']=='popular'):?> class="select"<?endif;?>><?=GetMessage('SORT_POP')?></a>
                    <a href="<?=$arResult['FOLDER']?>?sort=new"<?if($_GET['sort']=='new'):?> class="select"<?endif;?>><?=GetMessage('SORT_NEW')?></a>
                </div>
        ...
        <div class="wrapper">
            <div class="blog_list">
                ...
                <div class="subscribe">
                    <div class="subscribe-title"><?=GetMessage('SUBSCRIBE_TITLE')?></div>
