...
?>
<p><a class="back-link" href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>"><?=GetMessage("T_NEWS_DETAIL_BACK")?></a></p>
...
<p><a href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>"><?=GetMessage("T_NEWS_DETAIL_BACK")?></a></p><br>
...
<?if($arParams["USE_CATEGORIES"]=="Y" && $ElementID):
	...
	if(count($arCategoryFilter)>0):
		...
		?>
		<div class="bx-newslist posts_block">
