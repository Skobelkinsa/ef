...
<div class="bx-system-auth-form">
    <div class="main-auth-title tac"><?=GetMessage("MAIN_AUTH_TITLE")?></div>
    ...
    <?if($arResult["FORM_TYPE"] == "login"):?>
        ...
        <form name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
            ...
            <table width="300px" style="margin: 0 auto;">
                <tr>
                    <td colspan="2">
                        <input type="text" class="insty" name="USER_LOGIN" placeholder="<?=GetMessage("AUTH_LOGIN")?>" maxlength="50" value="<?=$arResult["USER_LOGIN"]?>" size="17" /></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <input type="password" class="insty" name="USER_PASSWORD" placeholder="<?=GetMessage("AUTH_PASSWORD")?>" maxlength="50" size="17" autocomplete="off" />
                ...
                <?if ($arResult["STORE_PASSWORD"] == "Y"):?>
                    <tr>
                        <td valign="midle"><input type="checkbox" id="USER_REMEMBER_frm" name="USER_REMEMBER" value="Y" /><label for="USER_REMEMBER_frm" title="<?=GetMessage("AUTH_REMEMBER_ME")?>"><?echo GetMessage("AUTH_REMEMBER_SHORT")?></label>
                        </td >
