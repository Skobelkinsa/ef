...
<ul class="<? echo $arCurView['LIST']; ?>">
    <li <?if($APPLICATION->GetCurPage(false) == "/produktsiya/"):?>class="all-products"<?endif;?>>
        <h2 class="bx_sitemap_li_title"><a href="/produktsiya/">Все</a>
        </h2></li>
<?
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'LIST':
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				<li <?if($arSection['SELECT']=='Y'):?>class="all-products"<?endif;?> id="<?=$this->GetEditAreaId($arSection['ID']);?>"><h2 class="bx_sitemap_li_title"><a href="<? echo $arSection["SECTION_PAGE_URL"]; ?>"><? echo $arSection["NAME"];?><?
				if ($arParams["COUNT_ELEMENTS"])
				{
					?> <span>(<? echo $arSection["ELEMENT_CNT"]; ?>)</span><?
				}
